...
while 1:
    ...
    if(sel == 0):
        ...
        bank = input("Where save in ?")
        test.savein(bank)
    elif(sel == 4):
        info = input("Where draw out ?")
        test.drawout(info)


#출처: https://maks.tistory.com/entry/Python으로-만드는-간단한-프로그램 [막장인생의 막장 스토리]